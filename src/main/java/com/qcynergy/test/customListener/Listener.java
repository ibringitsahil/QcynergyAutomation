package com.qcynergy.test.customListener;
...
public class Listener extends BaseTest implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		if(!result.isSuccess()){
			...
			try {
				//System.getProperty("user.dir") tells us current project location
				//getAbsolutePath gives complete path of file starting from drive name like absolute xpath
				String reportDirectory = new File(System.getProperty("user.dir")).getAbsolutePath() + "/src/main/java/com/qcynergy";
				File destFile = new File((String) reportDirectory + "/screenshots/" + methodName + "_" + formater.format(calendar.getTime()) + ".png");
				String dest=(String) reportDirectory + "/screenshots/" + methodName + "_" + formater.format(calendar.getTime()) + ".png";
